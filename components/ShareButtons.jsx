...
/**
 * Share buttons for Facebook, Instagram (copy link), and WhatsApp
 * Note: Instagram doesn't support direct link sharing - we open the app or copy link
 */
  ...
  return (
    <div className="share-buttons" style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' }}>
      ...
      <button
        ...
        aria-label="Copy link (share to Instagram)"
