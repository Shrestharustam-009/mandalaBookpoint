...
export async function initDatabase() {
  ...
  try {
    if (dbType === 'mysql') {
      ...
      // Auto-migration: Ensure book_categories table exists
      try {
        db.prepare(`
        ...
        `).run();
        console.log("[Auto-Migration] Checked/Created book_categories table in library.db successfully!");
      } catch (err) {
        console.error("[Auto-Migration] Failed to run auto-migration for book_categories table:", err);
      }
